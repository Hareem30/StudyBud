...
studybuddy/
│
├── matching.py          # Contains similarity scoring logic
├── test_matching.py     # Unit tests for the matching algorithm
├── index.html           # Basic front-end landing page
├── logo_hack.PNG        # Project logo
└── README.md
